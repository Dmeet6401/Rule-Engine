...
//   console.log("Evaluation Result: ", result);  // Should return true based on the rule and data
  
//   const data2 = { age: 24, department: 'Marketing' };
//   const result2 = evaluateAST(ast, data2);
//   console.log("Evaluation Result: ", result2);  // Should return true based on the rule and data
  
//   const data3 = { age: 26, department: 'Engineering' };
//   const result3 = evaluateAST(ast, data3);
//   console.log("Evaluation Result: ", result3);  // Should return false based on the rule and data
...
const result3 = evaluateAST(ast, data3);
console.log("Evaluation Result: xvxv ", ast); // Should return true based
console.log("Evaluation Result: ", result3);  // Should return false based on the rule and data
